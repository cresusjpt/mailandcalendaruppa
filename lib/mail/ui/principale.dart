...
import 'package:mailandcalendaruppa/mail/models/dummy_data.dart';
import 'package:mailandcalendaruppa/mail/models/email.dart';
import 'package:mailandcalendaruppa/mail/ui/app/app.dart';
...
class _HomeScreenState extends State<MailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveScaffold.builder(
      ...
      detailBuilder: (BuildContext context, int index,bool bool) {
