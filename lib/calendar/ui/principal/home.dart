...
import 'package:mailandcalendaruppa/calendar/ui/custom_event/custom_event.dart';
...
import 'package:mailandcalendaruppa/calendar/widgets/courses/course_list.dart';
import 'package:mailandcalendaruppa/calendar/widgets/drawer.dart';
...
class _HomeScreenState extends BaseState<HomeScreen>
  ...
  CalendarType _mailClientType = CalendarType.MAIL_CLIENT;
  ...
  void _switchMailTypeView(){
    setState(() => _calendarType = getMailCalendarType());
    prefs.setCalendarType(_calendarType);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppbarPage(
      ...
      actions: [
        ...
        IconButton(
          icon: Icon(getMailClientTypeIcon()),
          onPressed: _switchMailTypeView,
        )
      ],
      drawer: MainDrawer(),
